...
nc = Dataset('D:/NowWorking/newProjet/data/images_dom_old/dom_CanRCM4_ARC44.nc')
...
cgbvr = mpl.colors.ListedColormap([[0., 1., 1.], [.8, 1., .2], [.6, 1., 0.],  [.2, .8, 0.], [0., .6, 0.], [.6, 1., 1.], [0., 1., 1.], [0., 0., 1.], [0., 0., .6], [0., 0., .4], [.8, .6, 1.], [.8, .4, 1.], [.6, 0., 1.],  [.4, 0., .6], [.8, 0., 0.], [.4, 0., 0.]])
#cgbvr = mpl.colors.ListedColormap([[.2, .8, 0.], [.8, 1., .2], [.6, 1., 0.],  [.2, .8, 0.], [0., .6, 0.], [.6, 1., 1.], [0., 1., 1.], [0., 0., 1.], [0., 0., .6], [0., 0., .4], [.8, .6, 1.], [.8, .4, 1.], [.6, 0., 1.],  [.4, 0., .6], [.8, 0., 0.], [.4, 0., 0.]])

cs = m.contourf(x,y,data,clevs, cmap=cgbvr)
plt.tight_layout()
plt.savefig('D:/NowWorking/newProjet/results/images_alte/dom_canRCM4ARC_large2.png', dpi=300)
