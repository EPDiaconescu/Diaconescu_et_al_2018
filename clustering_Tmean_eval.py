...
output='D:/NowWorking/newProjet/results/domARC_CORDEX_b/clustering_Anom_eval/'
outputAnom='D:/NowWorking/newProjet/results/domARC_CORDEX_b/stations_Anom_eval/'
outputMean= 'D:/NowWorking/newProjet/results/domARC_CORDEX_b/stations_climMean_eval/'
...
for varName in list_varName:
    ...
    ###################################################################
    df_coord0=pd.read_csv(input_coord, sep=',')
    df_coord=df_coord0.drop(['2100630','2201450'], axis=1)
...
plt.savefig(output+varName+'_eval.png')
fig2.clf()
