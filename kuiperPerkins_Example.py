...
#        plt.grid(True,linestyle="-", color=[0.7,0.7,0.7])
        ax.plot( [1], [0.9], '.', color='white', label='D ='+str(D)[:4])
        ...
        plt.xticks([-15,-10,-5,0,5,10,15,20,25,30,35],fontsize=24)
        plt.xlabel("TNn ($^\circ$ C)", fontsize=24)
...
#        ax.patch.set_facecolor('white')
#        plt.grid(True,linestyle="-", color=[0.7,0.7,0.7])
        ax.plot( [18], [0.09], '.', color='white', label='1-P ='+str(Pkval[mm])[:4])
